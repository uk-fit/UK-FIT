...
import { subTotal, quantity } from "../partials/Mixins"; // Removed totalCost import

import { cartListProduct } from "../partials/FetchApi";
// import { getBrainTreeToken, getPaymentProcess } from "./FetchApi"; // Commented out
import { fetchData } from "./Action"; // Removed fetchbrainTree and pay import

// import DropIn from "braintree-web-drop-in-react"; // Commented out
...
export const CheckoutComponent = (props) => {
  ...
  const [state, setState] = useState({
    ...
    error: false,
    success: false,
    // clientToken: null, // Commented out
    // instance: {}, // Commented out
  });

  useEffect(() => {
    fetchData(cartListProduct, dispatch);
    // fetchbrainTree(getBrainTreeToken, setState); // Commented out
